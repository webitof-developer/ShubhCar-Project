...
Here’s the full list of route files:

*backend/modules/admin/admin.routes.js
*backend/modules/analytics/analytics.routes.js
*backend/modules/auth/auth.routes.js
*backend/modules/brands/brands.routes.js
*backend/modules/cart/cart.routes.js
*backend/modules/categories/categories.routes.js
*backend/modules/categoryAttribute/categoryAttribute.routes.js
*backend/modules/coupons/coupons.routes.js
*backend/modules/emailTemplates/emailTemplates.routes.js
*backend/modules/entries/entries.routes.js
*backend/modules/inventory/inventory.routes.js
*backend/modules/inventoryLogs/inventoryLogs.routes.js
*backend/modules/invoice/invoice.routes.js
*backend/modules/media/media.routes.js
*backend/modules/models/models.routes.js
...
*backend/modules/pages/page.routes.js
*backend/modules/payments/payments.routes.js
*backend/modules/payments/webhook.routes.js
*backend/modules/productAttribute/productAttribute.routes.js
*backend/modules/productAttributeValues/productAttributeValues.routes.js
*backend/modules/productCompatibility/productCompatibility.routes.js
*backend/modules/productImages/productImages.routes.js
*backend/modules/products/products.routes.js
*backend/modules/productVariants/productVariant.routes.js
*backend/modules/returns/return.routes.js
*backend/modules/reviews/reviews.routes.js
*backend/modules/roles/roles.routes.js
*backend/modules/salesReports/salesReports.routes.js
*backend/modules/seo/seo.routes.js
*backend/modules/settings/settings.routes.js
*backend/modules/shipments/shipment.routes.js
*backend/modules/shippingRules/shippingRules.routes.js
*backend/modules/tags/tags.routes.js
...
*backend/modules/vehicle-management/routes/model.routes.js
*backend/modules/vehicle-management/routes/modelYear.routes.js
*backend/modules/vehicle-management/routes/variant.routes.js
*backend/modules/vehicle-management/routes/vehicle.routes.js
*backend/modules/vehicle-management/routes/vehicleEntity.routes.js
*backend/modules/vehicle-management/routes/year.routes.js
*backend/modules/vendors/vendors.routes.js
*backend/modules/wishlist/wishlist.routes.js