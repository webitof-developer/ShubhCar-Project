...
const orderSchema = new mongoose.Schema(
  {
    ...
    discountPercent: { type: Number, default: 0, immutable: true },
    salesmanId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: 'User',
      default: null,
    ...
    commissionPercent: { type: Number, default: 0, immutable: true },
    commissionAmount: { type: Number, default: 0, immutable: true },
    orderSource: {
      type: String,
      enum: ['dashboard'],
      default: 'dashboard',
