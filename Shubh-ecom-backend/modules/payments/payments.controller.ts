 ...
 */
exports.initiate = asyncHandler(async (req: PaymentsRequest, res: Response) => {
 ...
 * Auth + role + validation already enforced
 */
exports.retry = asyncHandler(async (req: PaymentsRequest, res: Response) => {
...
exports.getStatus = asyncHandler(async (req: PaymentsRequest, res: Response) => {
...
exports.confirmPayment = asyncHandler(async (req: PaymentsRequest, res: Response) => {
...
exports.adminApproveRefund = asyncHandler(async (req: PaymentsRequest, res: Response) => {
...
exports.adminList = asyncHandler(async (req: PaymentsRequest, res: Response) => {
