...
exports.list = asyncHandler(async (req: NotificationsRequest, res: Response) => {
  const data = await service.list({ user: req.user, filter: req.query });
  return success(res, data, 'Notifications fetched');
});

exports.get = asyncHandler(async (req: NotificationsRequest, res: Response) => {
  const data = await service.get(req.params.id, req.user);
  return success(res, data, 'Notification fetched');
});

exports.create = asyncHandler(async (req: NotificationsRequest, res: Response) => {
...
exports.update = asyncHandler(async (req: NotificationsRequest, res: Response) => {
...
exports.remove = asyncHandler(async (req: NotificationsRequest, res: Response) => {
...
exports.markRead = asyncHandler(async (req: NotificationsRequest, res: Response) => {
  const data = await service.markRead(req.params.id, req.user);
  return success(res, data, 'Notification marked read');
});

exports.markAllRead = asyncHandler(async (req: NotificationsRequest, res: Response) => {
  const data = await service.markAllRead(req.user, req.body);
  return success(res, data, 'Notifications marked read');
});

exports.summary = asyncHandler(async (req: NotificationsRequest, res: Response) => {
