...
exports.create = asyncHandler(async (req: PagesRequest, res: Response) => {
  const data = await pageService.create(req.body, req.user);
  return success(res, data, 'Page created', 201);
});

exports.update = asyncHandler(async (req: PagesRequest, res: Response) => {
...
exports.get = asyncHandler(async (req: PagesRequest, res: Response) => {
  const data = await pageService.get(req.params.id);
  return success(res, data);
});

exports.remove = asyncHandler(async (req: PagesRequest, res: Response) => {
...
exports.resolve = asyncHandler(async (req: PagesRequest, res: Response) => {
