...
exports.placeOrder = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.cancelMyOrder = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminUpdatePaymentStatus = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminFlagFraud = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminList = asyncHandler(async (req: OrdersRequest, res: Response) => {
  const data = await adminService.adminList(req.query, req.user);
  return success(res, data, 'Orders fetched');
});

exports.adminGetOrderHistory = asyncHandler(async (req: OrdersRequest, res: Response) => {
  const data = await adminService.adminGetOrderHistory(req.params.orderId);
  return success(res, data, 'Order history fetched');
});

exports.adminGetOrder = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminGetOrderNotes = asyncHandler(async (req: OrdersRequest, res: Response) => {
  const data = await adminService.adminGetOrderNotes(req.params.orderId);
  return success(res, data, 'Order notes fetched');
});

exports.adminAddOrderNote = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminCreateOrder = asyncHandler(async (req: OrdersRequest, res: Response) => {
...
exports.adminGetStatusCounts = asyncHandler(async (req: OrdersRequest, res: Response) => {
