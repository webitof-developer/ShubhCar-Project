...
exports.list = asyncHandler(async (req: EmailTemplatesRequest, res: Response) => {
  const data = await service.list(req.query);
  return success(res, data, 'Email templates fetched');
});

exports.get = asyncHandler(async (req: EmailTemplatesRequest, res: Response) => {
  const data = await service.get(req.params.id);
  return success(res, data, 'Email template fetched');
});

exports.create = asyncHandler(async (req: EmailTemplatesRequest, res: Response) => {
...
exports.update = asyncHandler(async (req: EmailTemplatesRequest, res: Response) => {
...
exports.remove = asyncHandler(async (req: EmailTemplatesRequest, res: Response) => {
