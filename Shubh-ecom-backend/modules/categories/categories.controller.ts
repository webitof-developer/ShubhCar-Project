...
exports.getChildren = asyncHandler(async (req: CategoriesRequest, res: Response) => {
  const data = await service.getChildren(req.params.parentId);
  return success(res, data);
});

exports.getBySlug = asyncHandler(async (req: CategoriesRequest, res: Response) => {
...
exports.create = [
  ...
  asyncHandler(async (req: CategoriesRequest, res: Response) => {
