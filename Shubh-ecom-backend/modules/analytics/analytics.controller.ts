...
const sanitizeAnalyticsQuery = (query: any = {}, { defaultLimit = DEFAULT_LIMIT } = {}) => {
...
const sendList = (res, data) => success(res, Array.isArray(data) ? data : [] as any[]);
...
exports.users = asyncHandler(async (req: AnalyticsRequest, res: Response) => {
...
exports.reviews = asyncHandler(async (req: AnalyticsRequest, res: Response) => {
