...
exports.create = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
...
exports.updateStatus = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
...
exports.list = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
  const data = await service.list(req.query);
  return success(res, data, 'Shipments fetched');
});

exports.get = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
  const data = await service.get(req.params.id);
  return success(res, data, 'Shipment fetched');
});

exports.remove = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
...
exports.trackByOrderItem = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
  const data = await service.track(req.user, req.params.orderItemId);
  return success(res, data, 'Shipment tracking fetched');
});

// calculate shipping cost
exports.calculate = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
...
exports.adminListByOrder = asyncHandler(async (req: ShipmentsRequest, res: Response) => {
