...
exports.create = asyncHandler(async (req: ReturnsRequest, res: Response) => {
...
exports.adminDecision = asyncHandler(async (req: ReturnsRequest, res: Response) => {
...
exports.complete = asyncHandler(async (req: ReturnsRequest, res: Response) => {
...
exports.list = asyncHandler(async (req: ReturnsRequest, res: Response) => {
  const data = await service.list(req.query);
  return success(res, data, 'Returns fetched');
});

exports.get = asyncHandler(async (req: ReturnsRequest, res: Response) => {
