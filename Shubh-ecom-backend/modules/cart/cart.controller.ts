...
exports.getCart = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.getSummary = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.getGuestSummary = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.addItem = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.removeItem = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.updateQuantity = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.applyCoupon = asyncHandler(async (req: CartRequest, res: Response) => {
...
exports.removeCoupon = asyncHandler(async (req: CartRequest, res: Response) => {
