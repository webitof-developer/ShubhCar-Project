...
exports.preview = asyncHandler(async (req: CouponsRequest, res: Response) => {
...
exports.create = asyncHandler(async (req: CouponsRequest, res: Response) => {
...
exports.update = asyncHandler(async (req: CouponsRequest, res: Response) => {
...
exports.remove = asyncHandler(async (req: CouponsRequest, res: Response) => {
...
exports.list = asyncHandler(async (req: CouponsRequest, res: Response) => {
  const data = await service.list(req.query);
  return success(res, data, 'Coupons fetched');
});

exports.listPublic = asyncHandler(async (req: CouponsRequest, res: Response) => {
  const data = await service.listPublic(req.query);
  return success(res, data, 'Coupons fetched');
});

exports.get = asyncHandler(async (req: CouponsRequest, res: Response) => {
  const data = await service.get(req.params.id);
  if (!data) return errorResp('Coupon not found', 404);
  return success(res, data, 'Coupon fetched');
});

exports.listUsage = asyncHandler(async (req: CouponsRequest, res: Response) => {
