...
exports.getBySlug = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.getByIdPublic = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.getCompatibility = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const data = await productService.getCompatibility(req.params.productId);
  return success(res, data);
});

exports.getAlternatives = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const data = await productService.getAlternatives(req.params.productId);
  return success(res, data);
});

exports.listByCategory = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.listFeatured = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const { cursor, limit } = req.query;
...
exports.adminGet = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const data = await productService.adminGetById(req.params.productId);
  return success(res, data, 'Product fetched');
});

exports.create = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.update = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.remove = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminList = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminApprove = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminDelete = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const data = await productService.remove(req.params.productId, req.user);
...
// ADMIN: restore
exports.adminRestore = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminForceDelete = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
// ADMIN: empty trash
exports.adminEmptyTrash = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.uploadImages = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkUpdatePreview = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkUpdateConfirm = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
// ADMIN: job status
exports.adminBulkUpdateStatus = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkCreatePreview = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkCreateConfirm = asyncHandler(async (req: ProductsRequest, res: Response) => {
  const { uploadId } = req.body || {};
...
exports.adminBulkCreateStatus = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkCreateTemplate = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkUpdateTemplate = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkCreateExport = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminBulkUpdateExport = asyncHandler(async (req: ProductsRequest, res: Response) => {
...
exports.adminDuplicateAsAftermarket = asyncHandler(async (req: ProductsRequest, res: Response) => {
