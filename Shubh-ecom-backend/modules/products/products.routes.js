 ...
 */
router.get('/id/:productId', validateId('productId'), controller.getByIdPublic);

/**
 * @openapi
 * /api/v1/products/id/{productId}/compatibility:
 *   get:
 *     summary: Get product vehicle compatibility
 *     tags: [Catalog]
 *     parameters:
 *       - in: path
 *         name: productId
 ...
 */
router.get('/id/:productId/compatibility', validateId('productId'), controller.getCompatibility);

/**
 * @openapi
 * /api/v1/products/id/{productId}/alternatives:
 *   get:
 ...
 *         schema: { type: string }
 *     responses:
 *       200: { description: Alternatives }
 */
router.get('/id/:productId/alternatives', validateId('productId'), controller.getAlternatives);
...
/**
 * @openapi
 * /api/v1/products/admin/bulk-update/preview:
 *   post:
 ...
 */
router.post('/admin/bulk-update/preview', adminLimiter, auth([ROLES.ADMIN]), bulkUpload.single('file'), controller.adminBulkUpdatePreview);

/**
 * @openapi
 * /api/v1/products/admin/bulk-update/template:
 *   get:
 ...
 */
router.get('/admin/bulk-update/template', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkUpdateTemplate);

/**
 * @openapi
 * /api/v1/products/admin/bulk-update/export:
 *   get:
 ...
 */
router.get('/admin/bulk-update/export', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkUpdateExport);

/**
 * @openapi
 * /api/v1/products/admin/bulk-update/confirm:
 *   post:
 ...
 */
router.post('/admin/bulk-update/confirm', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkUpdateConfirm);

/**
 * @openapi
 * /api/v1/products/admin/bulk-update/jobs/{jobId}:
 *   get:
 ...
 */
router.get('/admin/bulk-update/jobs/:jobId', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkUpdateStatus);

/**
 * @openapi
 * /api/v1/products/admin/bulk-create/preview:
 *   post:
 ...
 *       200: { description: Preview }
 */
router.post('/admin/bulk-create/preview', adminLimiter, auth([ROLES.ADMIN]), bulkUpload.single('file'), controller.adminBulkCreatePreview);

/**
 * @openapi
 * /api/v1/products/admin/bulk-create/confirm:
 *   post:
 ...
 *       200: { description: Enqueued/confirmed }
 */
router.post('/admin/bulk-create/confirm', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkCreateConfirm);

/**
 * @openapi
 * /api/v1/products/admin/bulk-create/jobs/{jobId}:
 *   get:
 ...
 *       200: { description: Job status }
 */
router.get('/admin/bulk-create/jobs/:jobId', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkCreateStatus);

/**
 * @openapi
 * /api/v1/products/admin/bulk-create/template:
 *   get:
 ...
 *       200: { description: Template }
 */
router.get('/admin/bulk-create/template', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkCreateTemplate);

/**
 * @openapi
 * /api/v1/products/admin/bulk-create/export:
 *   get:
 ...
 *       200: { description: Export }
 */
router.get('/admin/bulk-create/export', adminLimiter, auth([ROLES.ADMIN]), controller.adminBulkCreateExport);
 ...
 *       200: { description: Product }
 */
router.get('/admin/:productId', adminLimiter, auth([ROLES.ADMIN]), validateId('productId'), controller.adminGet);
