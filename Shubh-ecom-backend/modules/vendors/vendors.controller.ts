...
exports.getMine = asyncHandler(async (req: VendorsRequest, res: Response) => {
  const data = await service.getByOwner(req.user.id);
  return success(res, data);
});

exports.onboard = asyncHandler(async (req: VendorsRequest, res: Response) => {
...
exports.updateStatus = asyncHandler(async (req: VendorsRequest, res: Response) => {
...
exports.addDocuments = asyncHandler(async (req: VendorsRequest, res: Response) => {
  const data = await service.addDocuments(req.user.id, req.body);
  return success(res, data, 'Documents added');
});

exports.updateDetails = asyncHandler(async (req: VendorsRequest, res: Response) => {
...
exports.updateDetailsAdmin = asyncHandler(async (req: VendorsRequest, res: Response) => {
...
exports.updateBank = asyncHandler(async (req: VendorsRequest, res: Response) => {
