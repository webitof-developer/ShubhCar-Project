 ...
 * Public
 */
exports.register = asyncHandler(async (req: UsersRequest, res: Response) => {
 ...
 * Authenticated
 */
exports.getMyProfile = asyncHandler(async (req: UsersRequest, res: Response) => {
 ...
 * Authenticated
 */
exports.updateMyProfile = asyncHandler(async (req: UsersRequest, res: Response) => {
 ...
 * Authenticated
 */
exports.logout = asyncHandler(async (req: UsersRequest, res: Response) => {
...
exports.adminGetStatusCounts = asyncHandler(async (req: UsersRequest, res: Response) => {
  const data = await userService.adminGetStatusCounts(req.user);
  return res.ok(data, 'User stats fetched');
});

exports.adminList = asyncHandler(async (req: UsersRequest, res: Response) => {
  const data = await userService.adminList(req.user, req.query);
  return res.ok(data, 'Users fetched');
});
exports.adminCreate = asyncHandler(async (req: UsersRequest, res: Response) => {
...
exports.adminForcePasswordReset = asyncHandler(async (req: UsersRequest, res: Response) => {
...
exports.adminDelete = asyncHandler(async (req: UsersRequest, res: Response) => {
  const data = await userService.adminDelete(req.user, req.params.id);
  return res.ok(data, 'User deleted successfully');
});

exports.adminExportCustomers = asyncHandler(async (req: UsersRequest, res: Response) => {
...
exports.adminImportCustomers = asyncHandler(async (req: UsersRequest, res: Response) => {
