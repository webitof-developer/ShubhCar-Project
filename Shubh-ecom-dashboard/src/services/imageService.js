...
export const uploadVariantImages = async (variantId, files, token) => {
  ...
  void files;
  void token;
  throw new Error('Variant image upload endpoint is not available on backend yet');
};
...
export const deleteVariantImage = async (variantId, index, token) => {
  ...
  void index;
  void token;
  throw new Error('Variant image delete endpoint is not available on backend yet');
};
