...
export function OrderPreview({
  ...
  const taxDisplayMode =
    summary?.settings?.taxPriceDisplayCart ||
    summary?.settings?.taxPriceDisplayShop ||
    'excluding';
  const taxLabel = getTaxSuffix(taxDisplayMode, siteTax, summary?.settings);
  ...
  const hasValidAddress =
    addressId && (safeAddress.name || safeAddress.fullName);
              ...
              {hasValidAddress ? (
                <div className='space-y-2'>
                  <p className='font-semibold text-foreground'>
                    {safeAddress.name || safeAddress.fullName}
                  </p>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    ...
                    {safeAddress.postalCode || safeAddress.pincode}
                  </p>
                </div>
              ) : (
                <p className='text-sm text-muted-foreground'>
            ...
            <div className='p-5 space-y-4'>
              ...
              <div className='flex justify-between text-sm'>
                ...
                <span className='font-medium'>
                  {summaryLoading ? '...' : formatPrice(subtotal)}
                </span>
              </div>
              ...
              {showTaxTotals && (
                <div className='flex justify-between text-sm'>
                  ...
                  <span className='font-medium'>
                    {summaryLoading ? '...' : formatPrice(tax)}
                  </span>
                </div>
              )}
              ...
              <div className='flex items-start gap-2 text-xs text-muted-foreground pt-2'>
                ...
                <p>
                  Your payment information is secure. You&apos;ll review payment
