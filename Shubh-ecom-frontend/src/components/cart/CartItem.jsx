...
export const CartItem = ({
  ...
  const minQty = isWholesaleUser
    ? Math.max(
        1,
        Number(product.minWholesaleQty || product.minOrderQty || 1) || 1,
      )
  ...
  return (
    <div
      className='bg-card rounded-xl border border-border/50 p-3 md:p-4 animate-fade-in'
     >
      <div className='flex gap-4'>
        ...
        <Link
          ...
          <div className='absolute top-1.5 left-1.5 z-10 flex flex-col gap-1'>
            <Badge
              variant={
                isOemProduct(product.productType) ? 'default' : 'secondary'
              }
          ...
          <div>
            <div className='flex items-start justify-between gap-2'>
              <div className='min-w-0'>
                <Link
                  href={productLink}
                  className='font-semibold text-foreground hover:text-primary transition-colors line-clamp-2 text-sm md:text-base mb-1'>
                ...
                <div className='flex flex-wrap items-center gap-2 mb-2'>
                  ...
                  {type === 'wholesale' && (
                    <Badge
                      variant='default'
                      className='text-[10px] bg-blue-600 px-1.5 py-0.5 h-auto rounded-sm hover:bg-blue-700'>
                      Wholesale
                    </Badge>
                  )}
                </div>
